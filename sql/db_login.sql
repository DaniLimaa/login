...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/03/2025 às 12:11
...
(6, 'Bruce Banner', '1972', '99988877766', '333444555', '546464646', '123 Gamma Avenue', 7, 'Culver City', 'Los Angeles');
...
(1, 'homemDeFerro', '123123', 1),
(2, 'homemAranha', 'maryjani', 2),
(3, 'capitaoAmerica', 'euvouLutar', 3),
(4, 'viuvaNegra', 'assassinaVermelha', 4),
(5, 'deusDoTrovao', 'mjolnir', 5),
(6, 'hulk', 'smash iron man', 6);
